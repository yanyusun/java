...
public class AllOperTypeNavBean extends OperTypeNavBean{
    ...
    public Integer[] nav1 = {102, 1110, 1615, 1310, 1213};//待申请
    public Integer[] nav2 = {102, 1110, 1615, 1310, 1213, 100, 103, 104, 105, 107, 108, 109, 110,
            ...
            130, 131, 132, 133, 134, 135, 136, 137, 138, 1310,
            121, 122, 123, 124, 125, 126, 127, 1210, 1211,1213,
            151, 152, 153, 154, 155, 156, 157, 158, 159, 1511, 1512, 1513, 1515, 1516,1520};//正在处置
    ...
    public Integer[] nav7 = {102, 1110, 1615, 1310, 1213, LenderEnum.ADJOURNMENT.getValue()};//超时
    ...
    public Integer[] nav13 = {102, 1110, 1615, 1310,137,138, 1210,1213,
            1115, 116, 105, 107, 1611, 166};//待分配
    ...
    public Integer[] nav15 = {102, 1110, 1615, 1310, 1213, 100, 101, 103, 104, 105,107, 110,
            111, 112, 113, 114, 116, 117, 118, 119, 1111, 1115,
    ...
    public Integer[] nav16 = {102, 1110, 1615, 1310, 1213, 100, 103, 104, 105,107, 110,
            ...
            162, 163, 164, 165, 166, 167, 168, 169, 169, 1610, 1611, 1612, 1613, 1614,
            130, 131, 132, 133, 134, 135, 136, 137, 138, 1310,
            121, 122, 123, 124, 125, 126, 127, 129, 1210, 1211,1213};//处置中
