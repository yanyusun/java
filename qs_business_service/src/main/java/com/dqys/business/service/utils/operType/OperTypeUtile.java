...
//        opertype();
    ...
    private static Integer[] nav8 = {102, 1110, 1615, 1310, 1213, 108, 1118, 1613, 1212, 139};//无效
    private static Integer[] nav9 = {102, 1110, 1615, 1310, 1213};//待参与
    private static Integer[] nav10 = {102, 1110, 1615, 1310, 1213};//已参与
    private static Integer[] nav11 = {102, 1110, 1615, 1310, 1213, 103, 104, 1113, 1114, 169, 1610};//待审核
    private static Integer[] nav12 = {102, 1110, 1615, 1310, 1213};//待处置
    ...
    private static Integer[] nav15 = {102, 1110, 1615, 1310, 1213, 100, 101, 103, 104, 105, 106, 107, 108, 109, 110,
            111, 112, 113, 114, 115, 116, 117, 118, 119, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118,
            161, 162, 163, 164, 165, 166, 167, 168, 169, 169, 1610, 1611, 1612, 1613, 1614,
            130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 1310, 1311, 1312,
            120, 121, 122, 123, 124, 125, 126, 127, 129, 1210, 1211, 1212, 1214, 1215, 1216, 1217, 1218, 1220};//我的任务
    private static Integer[] nav16 = {102, 1110, 1615, 1310, 1213, 100, 101, 103, 104, 105, 106, 107, 108, 109, 110,
            111, 112, 113, 114, 115, 116, 117, 118, 119, 1111, 1112, 1113, 1114, 1115, 1116, 1117, 1118,
            161, 162, 163, 164, 165, 166, 167, 168, 169, 169, 1610, 1611, 1612, 1613, 1614,
            130, 131, 132, 133, 134, 135, 136, 137, 138, 139, 1310, 1311, 1312,
            120, 121, 122, 123, 124, 125, 126, 127, 129, 1210, 1211, 1212, 1214, 1215, 1216, 1217, 1218, 1220};//处置中
    private static Integer[] nav17 = {102, 1110, 1615, 1310, 1213, 105, 107, 101, 1115, 116, 111, 1611, 166, 161, 1312,
            139, 1219, 1212, 106, 1116, 1612, 103, 1113, 169};//已驳回
