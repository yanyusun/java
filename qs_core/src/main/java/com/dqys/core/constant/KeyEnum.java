...
public class KeyEnum {
    ...
    public static final String SYS_FILE_PIC_ERROR_FILENAME = "sys_file_error_pic_path"; //找不到图片时所显示的图片的路劲
    ...
    /* 文件上传格式限制配置 */
    public static final String UPLOAD_PERMIT_IMG = "2"; // 图片格式
    public static final String UPLOAD_PERMIT_OFFICE = "3"; // 办公文件
    public static final String UPLOAD_PERMIT_AUDIO = "4"; // 音频
    public static final String UPLOAD_PERMIT_VIDEO = "5"; // 视频
    ...
    public static final String SMS_URL = "http://222.73.117.169/msg/HttpBatchSendSM";
    public static final String SMS_ACCOUNT = "N2120414";
    public static final String SMS_PASSWORD = "Ps20643e";
