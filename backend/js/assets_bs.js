...
$(function(){
	...
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1100}, '#table_working', '#working');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1110 }, '#table_toBeAudit', '#toBeAudit');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1120}, '#table_retorted', '#retorted');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1030}, '#table_toBePub', '#toBePub');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1040}, '#table_hasPubed', '#hasPubed');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1050}, '#table_hasOff', '#hasOff');
	getAssetList({page:1, pageCount:qs_pagination.pageCount, businessStatus:1060}, '#table_useless', '#useless');
