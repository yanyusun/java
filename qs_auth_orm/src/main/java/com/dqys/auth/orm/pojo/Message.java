...
public class Message extends BaseQuery implements Serializable {
    ...
    public Message(String title, String content, Integer senderId, Integer receiveId, String label, String sendTime,
                   Integer type, Integer status, Integer businessType, String operUrl, Integer operStatus) {
        this.title = title;
