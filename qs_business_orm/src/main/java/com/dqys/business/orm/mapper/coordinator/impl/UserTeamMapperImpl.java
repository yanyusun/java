...
public class UserTeamMapperImpl extends BaseDao implements UserTeamMapper {
    ...
    @Override
    public List<Integer> selectByCompany(Integer companyId) {
        return super.getSqlSession().getMapper(UserTeamMapper.class).selectByCompany(companyId);
    }
    ...
    @Override
    public UserTeam getByObject(@Param("id") Integer id, @Param("type") Integer type) {
        return super.getSqlSession().getMapper(UserTeamMapper.class).getByObject(id, type);
    }
