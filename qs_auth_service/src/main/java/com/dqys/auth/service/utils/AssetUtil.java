...
public class AssetUtil {
    ...
    public static final String PRE_ASSET_CODE = "QS";
    public static final String PRE_PAWN_CODE = "抵";
    public static final String PRE_LENDER_CODE = "JKR";
    public static final String MIDDLE_IOU_CODE = "-借";
